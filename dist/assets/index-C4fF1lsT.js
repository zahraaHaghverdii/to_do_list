...
`;function Co(){return e.jsxs(So,{children:[e.jsx(To,{}),e.jsx(jo,{})]})}const Mo=i.ul`
  display: flex;
...
`;function _o(){return e.jsx(Do,{children:e.jsx(Lo,{})})}const $o=i.div`
  display: grid;
  grid-template-areas:
    "header header"
    "sidebar main";
...
`;function M(){return e.jsx(or,{children:e.jsx(rr,{})})}const tr=i.div`
  background-color: var(--color-grey-0);
  border: 1px solid var(--color-grey-100);
  border-radius: var(--border-radius-md);
...
`,ir=i.p`
  ...
  font-weight: 500;
  margin-top: 0.8rem;
`;function ar(){const{taskDoingAndAll:o,isLoading:r}=xe();return e.jsxs(tr,{children:[e.jsx(nr,{children:"Today"}),r?e.jsx(M,{}):(o==null?void 0:o.length)>0?e.jsx(sr,{children:o==null?void 0:o.map(t=>e.jsx(er,{task:t},t.id))}):e.jsx(ir,{children:"You have nothing to do today..."})]})}const W=i.div`
  background-color: var(--color-grey-0);
  border: 1px solid var(--color-grey-100);
  border-radius: var(--border-radius-md);
...
`;function ee({error:o,label:r,children:t}){return e.jsxs(e.Fragment,{children:[e.jsxs(Tr,{children:[r&&e.jsx(Sr,{htmlFor:t.props.id,children:r}),t]}),o&&e.jsx(Cr,{children:o})]})}const Mr=i.form`
  ${o=>o.type!=="modal"&&w`
      padding: 2.4rem 4rem;
...
`;function Wr(){const{tasks:o,isLoading:r}=z(),t=["all","doing","done"],n=[...new Set(o==null?void 0:o.map(a=>a.status))],s=[...t,...n.filter(a=>!t.includes(a))];return e.jsxs(Fr,{children:[r&&e.jsx(M,{}),e.jsx(Nr,{columns:s.length,children:s.map(a=>e.jsxs(Rr,{children:[e.jsxs(Pr,{status:a,children:[e.jsx(pe,{status:a}),a.toUpperCase(),"(",o==null?void 0:o.filter(d=>d.status===a).length,")"]}),e.jsx(qr,{children:(o==null?void 0:o.filter(d=>d.status===a).length)===0?e.jsx(Hr,{children:"There is no task"}):o==null?void 0:o.filter(d=>d.status===a).map(d=>e.jsx(Ir,{task:d},d.id))})]},a))})]})}const Ar=i.div`
  display: flex;
  justify-content: flex-end;
  align-items: center;
  gap: 1rem;
